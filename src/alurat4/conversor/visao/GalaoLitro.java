...
public class GalaoLitro extends JFrame {
	...
	public GalaoLitro() {
		...
		CBSelecaoUnidade.setModel(new DefaultComboBoxModel(
				new String[] { "<Selecione uma das opções>", "MPG-KML Milhas por galão para Quilômetros por litro.",
						"KML-MPG Quilômetros por litro para Milhas por galão." }));
		...
		btnConverteUnidade.addKeyListener(new KeyAdapter() {
			@Override
			public void keyPressed(KeyEvent evt) {
				 if (evt.getKeyCode() == evt.VK_ENTER) {                    
					 btnConverteUnidade.requestFocus();
		            }
			}
		});
		btnConverteUnidade.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				textFieldUnidadeEntrada.requestFocus();
				...
				} else if (CBSelecaoUnidade.getSelectedItem()
						.equals("MPG-KML Milhas por galão para Quilômetros por litro.")) {
				...
				if (ax.escolha == JOptionPane.YES_OPTION) {
					...
					textFieldUnidadeEntrada.setText(ax.limparCampo());
					textFieldSaida.setText(ax.limparCampo());
					textFieldUnidadeEntraAbreviada.setText(ax.limparCampo());
					textFieldUnidadeSaidaAbreviada.setText(ax.limparCampo());
		...
		gl_contentPane
				.setHorizontalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_contentPane
								.createSequentialGroup().addContainerGap(353, Short.MAX_VALUE)
								.addComponent(btnConverteUnidade, GroupLayout.PREFERRED_SIZE, 87,
										GroupLayout.PREFERRED_SIZE)
								.addGap(234))
						.addGroup(gl_contentPane.createSequentialGroup().addContainerGap()
								.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING, false)
										.addComponent(lblValorTotal, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
												Short.MAX_VALUE)
										.addComponent(lblUnidadeEntrada, GroupLayout.DEFAULT_SIZE, 246,
												Short.MAX_VALUE))
								.addPreferredGap(ComponentPlacement.RELATED)
								.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING, false)
										.addComponent(textFieldSaida).addComponent(
												textFieldUnidadeEntrada, GroupLayout.DEFAULT_SIZE, 184,
												Short.MAX_VALUE))
								.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
										.addGroup(gl_contentPane.createSequentialGroup().addGap(44)
												.addComponent(lblDeEntrda))
										.addGroup(gl_contentPane
												.createSequentialGroup().addGap(45).addComponent(lblDeSaida,
														GroupLayout.PREFERRED_SIZE, 17, GroupLayout.PREFERRED_SIZE)))
								.addGap(45)
								.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
										.addComponent(textFieldUnidadeEntraAbreviada, GroupLayout.DEFAULT_SIZE, 66,
												Short.MAX_VALUE)
										.addComponent(textFieldUnidadeSaidaAbreviada, GroupLayout.DEFAULT_SIZE, 66,
												Short.MAX_VALUE))
								.addGap(57))
						.addGroup(gl_contentPane
								.createSequentialGroup().addGap(70).addComponent(CBSelecaoUnidade,
										GroupLayout.PREFERRED_SIZE, 521, GroupLayout.PREFERRED_SIZE)
								.addContainerGap(83, Short.MAX_VALUE)));
		gl_contentPane.setVerticalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup().addGap(22)
						.addComponent(CBSelecaoUnidade, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE)
						.addGap(40)
						.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE).addComponent(lblUnidadeEntrada)
								.addComponent(textFieldUnidadeEntrada, GroupLayout.PREFERRED_SIZE,
										GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
								.addComponent(textFieldUnidadeEntraAbreviada, GroupLayout.PREFERRED_SIZE, 21,
										GroupLayout.PREFERRED_SIZE)
								.addComponent(lblDeEntrda))
						.addGap(4).addComponent(btnConverteUnidade).addPreferredGap(ComponentPlacement.RELATED)
						.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE).addComponent(lblValorTotal)
								.addComponent(textFieldSaida, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
								.addComponent(textFieldUnidadeSaidaAbreviada, GroupLayout.PREFERRED_SIZE, 22,
										GroupLayout.PREFERRED_SIZE)
