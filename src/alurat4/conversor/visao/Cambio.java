...
public class Cambio extends JFrame {
	...
	public Cambio() {
		...
		CBSelecaoMoedas.setModel(new DefaultComboBoxModel(new String[] {"<Selecione uma das opções>", "BRL-USD De Reais a Dólares.", "BRL-EUR De Reais a Euros.", "BRL-GBP De Reais a Libras Esterlinas.", "BRL-ARS De Reais a Peso Argentino.", "BRL-CLP De Reais a Peso Chileno.", "USD-BRL De Dólares a Reais.", "EUR-BRL De Euros a Reais.", "GBP-BRL De Libras Esterlinas a Reais.", "ARS-BRL De Peso Argentino a Reais.", "CLP-BRL De Peso Chileno a Reais."}));
				...
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addGroup(Alignment.TRAILING, gl_contentPane.createSequentialGroup()
							...
							.addGap(67)
							.addComponent(textFTotalCambiado, GroupLayout.PREFERRED_SIZE, 221, GroupLayout.PREFERRED_SIZE)
							.addGap(272))
						.addGroup(gl_contentPane.createSequentialGroup()
							.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_contentPane.createSequentialGroup()
							...
							.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
								...
								.addGroup(gl_contentPane.createSequentialGroup()
									.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING)
										.addComponent(textFMoedaDeSaida, Alignment.LEADING, 221, 221, 221)
